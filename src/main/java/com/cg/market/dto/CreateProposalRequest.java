...
public class CreateProposalRequest {
	...
	public CreateProposalRequest(Integer propId, String proposal, double amount, LocalDate proposalDate,
	...
	public String toString() {
		return "CreateProposalRequest [propId=" + propId + ", proposal=" + proposal + ", amount=" + amount
